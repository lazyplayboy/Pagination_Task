...
function createFormElements(latxt, typ, idname) {
    var d = document.createElement('div');
    d.setAttribute('class', 'form-group row');
    var la = document.createElement('label');
    la.classList.add('label', 'col-4', 'col-form-label');
    la.innerHTML = latxt;
    var input = document.createElement('input');
    input.setAttribute('type', typ);
    input.id = idname;
    input.placeholder = latxt;
...
function createMultiSelect() {
    ...
    label.innerHTML = "Favourite Foods"

    var select = document.createElement('select');
    select.multiple = true;
    select.id = 'food'
    select.setAttribute('class', 'form-control col-6')
    var opt1 = new Option('Burger', 'Burger');

    var opt2 = new Option('chicken', 'chicken');
    var opt3 = new Option('Dosa', 'Dosa');
    var opt4 = new Option('Noodles', 'Noodles');
    var opt5 = new Option('Veg Biryani', 'Veg Biryani');
    opt2.selected = true;
